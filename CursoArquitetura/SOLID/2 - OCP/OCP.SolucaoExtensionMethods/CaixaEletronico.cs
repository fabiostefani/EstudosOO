...
namespace SOLID._2___OCP.OCP.SolucaoExtensionMethods
{
    public class CaixaEletronico
    {
        public void Operacoes()
        {
            ...
            {
                case '1':
                    Console.WriteLine("Efetuando operaçã em Conta Corrente");
                    retorno = debitoConta.DebitarContaCorrente();
                    break;
                case '2':
                    Console.WriteLine("Efetuando operaçã em Conta Poupança");
                    retorno = debitoConta.DebitarContaPoupanca();
                    break;
                case '3':
                    Console.WriteLine("Efetuando operaçã em Conta Investimento");
